...
public class ShowPurchasedActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        setContentView(R.layout.activity_show_purchased);
        ...
        mAdapter=new ProfileAdapter(ShowPurchasedActivity.this,myUploads);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange( DataSnapshot dataSnapshot ) {
                ...
                {
                    if(u.getmBidder().equals(uname) && u.getmStatus().equals("INACTIVE"))
                    {
                        myUploads.add(u);
                    }
                }
            ...
            public void onCancelled( DatabaseError databaseError ) {
                Toast.makeText(ShowPurchasedActivity.this,databaseError.getMessage(),Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
