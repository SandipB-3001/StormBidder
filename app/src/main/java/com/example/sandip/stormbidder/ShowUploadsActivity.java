...
public class ShowUploadsActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        mAdapter=new ProfileAdapter(ShowUploadsActivity.this,myUploads);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange( DataSnapshot dataSnapshot ) {
                ...
                {
                    if(u.getmUserName().equals(uname))
                    {
                        myUploads.add(u);
                    }
                }
