...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,ImageAdapter.OnItemClickListener{
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange( DataSnapshot dataSnapshot ) {
                ...
                for(DataSnapshot postSnapshot:dataSnapshot.getChildren())
                {
                    ...
                    if(upload.getmStatus().equals("ACTIVE"))
                        mUploads.add(upload);
                }
    ...
    public void onDeleteClick( int position ) {
        Upload selectedItem=mUploads.get(position);
        String userName=selectedItem.getmUserName();
        final String selectedKey=selectedItem.getmKey();
